...
- SparkSwitch Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called SparkSwitch Lite. It should be a full-viewport timing reflex game where the player toggles between two rails to collect timed pulses, includes a settings overlay, score/level HUD, pause/resume, restart, keyboard and click controls, and must be playable locally in the brows…
...
- Gameplay - SparkSwitch Lite
- Game Settings - SparkSwitch Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - SparkSwitch Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - SparkSwitch Lite
